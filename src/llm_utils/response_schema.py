...
def get_protocol_response_schema() -> dict:
    """
    Get the JSON schema for relay protocol generation responses.

    This schema enforces that models return a structured response with:
    - reasoning: Brief explanation of protocol generation approach
    - protocol: The markdown relay protocol content
